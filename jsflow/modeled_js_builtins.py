...
def setup_js_builtins(G: Graph):
    ...
    G.set_node_attr(opg_tainted_obj, ("tainted", True))
    opg_tainted_wildcard_obj = G.add_obj_to_name(
        "__opgTaintedWildcard", scope=G.BASE_SCOPE
    )
    G.set_node_attr(opg_tainted_wildcard_obj, ("tainted", True))
    opg_tainted_fake_arg_cons = G.add_blank_func_to_scope(
        "__OpgTaintedFakeArg",
        scope=G.BASE_SCOPE,
        python_func=opg_tainted_fake_arg_constructor,
    )
    G.add_blank_func_to_scope(
        "__opgMarkTaintedFakeArg",
        scope=G.BASE_SCOPE,
        python_func=opg_mark_tainted_fake_arg,
    )
    G.builtin_constructors.append(opg_tainted_fake_arg_cons)
    G.add_blank_func_to_scope(
        "__opgCombine", scope=G.BASE_SCOPE, python_func=opg_combine
    )
...
def setup_string(G: Graph):
    ...
    string_prototype = G.get_prop_obj_nodes(
        prop_name="prototype", parent_obj=string_cons
    )[0]
...
def setup_number(G: Graph):
    ...
    number_prototype = G.get_prop_obj_nodes(
        prop_name="prototype", parent_obj=number_cons
    )[0]
    G.number_prototype = number_prototype
    # Number.prototype.__proto__ = Object.prototype
    G.add_obj_as_prop(
        prop_name="__proto__",
        parent_obj=number_prototype,
        tobe_added_obj=G.object_prototype,
    )
...
def setup_array(G: Graph):
    ...
    array_prototype = G.get_prop_obj_nodes(
        prop_name="prototype", parent_obj=array_cons
    )[0]
    G.array_prototype = array_prototype
    # Array.prototype.__proto__ = Object.prototype
    G.add_obj_as_prop(
        prop_name="__proto__",
        parent_obj=array_prototype,
        tobe_added_obj=G.object_prototype,
    )
...
def setup_boolean(G: Graph):
    ...
    boolean_prototype = G.get_prop_obj_nodes(
        prop_name="prototype", parent_obj=boolean_cons
    )[0]
    G.boolean_prototype = boolean_prototype
    # Boolean.prototype.__proto__ = Object.prototype
    G.add_obj_as_prop(
        prop_name="__proto__",
        parent_obj=boolean_prototype,
        tobe_added_obj=G.object_prototype,
    )
...
def setup_symbol(G: Graph):
    ...
    symbol_prototype = G.get_prop_obj_nodes(
        prop_name="prototype", parent_obj=symbol_cons
    )[0]
    # Symbol.prototype.__proto__ = Object.prototype
    G.add_obj_as_prop(
        prop_name="__proto__",
        parent_obj=symbol_prototype,
        tobe_added_obj=G.object_prototype,
    )
...
def setup_object_and_function(G: Graph):
    ...
    object_prototype = G.get_prop_obj_nodes(
        prop_name="prototype", parent_obj=object_cons
    )[0]
    G.set_node_attr(object_prototype, ("code", "Object.prototype"))
    # add Object.prototype.__proto__
    G.add_obj_as_prop(
        prop_name="__proto__", parent_obj=object_prototype, tobe_added_obj=G.null_obj
    )
    # add Function (function)
    function_cons = G.add_blank_func_to_scope(
        "Function", scope=G.BASE_SCOPE
    )  # TODO: implement this
    G.builtin_constructors.append(function_cons)
    G.function_cons = function_cons
    # get Function.prototype
    function_prototype = G.get_prop_obj_nodes(
        prop_name="prototype", parent_obj=function_cons
    )[0]
    ...
    function__proto__ = G.add_obj_as_prop(
        prop_name="__proto__",
        parent_obj=function_cons,
        tobe_added_obj=function_prototype,
    )
    # Function.prototype.__proto__ = Object.prototype (because Function.prototype is an object)
    function__proto____proto__ = G.add_obj_as_prop(
        prop_name="__proto__",
        parent_obj=function_prototype,
        tobe_added_obj=object_prototype,
    )
    # Object.__proto__ = Function.prototype (beacuse Object is a function)
    G.add_obj_as_prop(
        prop_name="__proto__", parent_obj=object_cons, tobe_added_obj=function_prototype
    )
    # set reserved values
    ...
    G.add_obj_as_prop(
        "getOwnPropertySymbols", parent_obj=object_cons, tobe_added_obj=G.false_obj
    )

    G.add_blank_func_as_prop("toString", object_prototype, object_p_to_string_simp)
    G.add_blank_func_as_prop(
        "toLocaleString", object_prototype, object_p_to_string_simp
    )
    G.add_blank_func_as_prop("valueOf", object_prototype, this_returning_func)
    G.add_blank_func_as_prop(
        "hasOwnProperty", object_prototype, object_p_has_own_property
    )
...
def setup_global_functions(G: Graph):
    ...
    decode_uri = G.add_blank_func_to_scope(
        "decodeURI", G.BASE_SCOPE, string_returning_func
    )
    decode_uri_component = G.add_blank_func_to_scope(
        "decodeURIComponent", G.BASE_SCOPE, string_returning_func
    )
    encode_uri = G.add_blank_func_to_scope(
        "encodeURI", G.BASE_SCOPE, string_returning_func
    )
    encode_uri_component = G.add_blank_func_to_scope(
        "encodeURIComponent", G.BASE_SCOPE, string_returning_func
    )
    escape = G.add_blank_func_to_scope("escape", G.BASE_SCOPE, string_returning_func)
    unescape = G.add_blank_func_to_scope(
        "unescape", G.BASE_SCOPE, string_returning_func
    )
    set_timeout = G.add_blank_func_to_scope(
        "setTimeout", G.BASE_SCOPE, func_calling_func
    )
    clear_timeout = G.add_blank_func_to_scope("clearTimeout", G.BASE_SCOPE, blank_func)
    set_interval = G.add_blank_func_to_scope(
        "setInterval", G.BASE_SCOPE, func_calling_func
    )
...
def array_p_for_each(
    G: Graph,
    caller_ast,
    extra,
    array=NodeHandleResult(),
    ...
    for arr in array.obj_nodes:
        for name_node in G.get_prop_name_nodes(arr):
            ...
            if str(name).startswith("Obj#"):
                ...
                name_obj_node = G.add_obj_node(
                    ast_node=caller_ast, js_type="number", value=float(name)
                )
            obj_nodes_log = ", ".join(
                [
                    f'{sty.fg.green}{obj}{sty.rs.all}: {G.get_node_attr(obj).get("code")}'
                    for obj in obj_nodes
                ]
            )
            logger.debug(
                f"Array forEach callback arguments: index={name} ({sty.fg.green}{name_obj_node}{sty.rs.all}), obj_nodes={obj_nodes_log}, array={arr}"
            )
            opgen.call_function(
                G,
                callback.obj_nodes,
                args=[
                    NodeHandleResult(
                        name_nodes=[name_node], name=name, obj_nodes=obj_nodes
                    ),
...
def array_p_for_each_value(
    ...
    for arr in array.obj_nodes:
        ...
        for name_node in name_nodes:
            ...
            logger.debug(
                f"Array forEach callback arguments: index={name}, length~={len(name_nodes)}, obj_nodes={obj_nodes_log}, array={arr}"
            )
            ...
            def add_for_stack(G, **kwargs):
                ...
                G.for_stack.append(
                    (
                        ...
                        loop_var_name,
                        name,
                        G.get_prop_obj_nodes(arr, numeric_only=True),
                        array.obj_nodes,
                    )
                )
...
def array_p_for_each_static(
    ...
    logger.debug(
        sty.fg.green
        + f"Calling callback functions {callback.obj_nodes} with elements {objs}."
        + sty.rs.all
    )
    for func in callback.obj_nodes:
        ...
        func_scope = G.add_scope(
            "FUNC_SCOPE",
            func,
            f"Function{func_decl}:{caller_ast}",
            func,
            caller_ast,
            func_name,
        )
        opgen.call_callback_function(
            G,
            caller_ast,
            func_decl,
            func_scope,
...
def array_p_for_each_static_new(
    G: Graph,
    caller_ast,
    extra,
    array: NodeHandleResult,
    ...
    for arr in array.obj_nodes:
        name_nodes = G.get_prop_name_nodes(arr)
        parent_for_tags = (
            BranchTagContainer(G.get_node_attr(arr).get("for_tags", []))
        ...
        for name_node in name_nodes:
            ...
            for obj in G.get_obj_nodes(name_node, branches=branches):
                ...
                names.append(name)
                new_tag = BranchTag(
                    point=f"ForEach{caller_ast}", branch=counter, mark="L"
                )
                ...
                counter += 1
    args = [
        NodeHandleResult(obj_nodes=objs),
    ...
    new_extra = ExtraInfo(
        extra, branches=extra.branches + [BranchTag(point=f"ForEach{caller_ast}")]
    )
    opgen.call_function(
        G,
        callback.obj_nodes,
...
def array_p_push(
    ...
    *tobe_added_objs: NodeHandleResult,
    ...
    if (
        ...
        and len(arrays.obj_nodes) < G.array_obj_node_limit
    ):
        logger.debug(
            "Copy arrays {} for branch {}, name nodes {}".format(
                arrays.obj_nodes,
                extra.branches.get_last_choice_tag(),
                arrays.name_nodes,
            )
        )
        arrays = copy_objs_for_branch(
            G, arrays, branch=extra.branches.get_last_choice_tag(), ast_node=caller_ast
        )
    for arr in arrays.obj_nodes:
        length_objs = G.get_prop_obj_nodes(
            parent_obj=arr, prop_name="length", branches=extra.branches
        )
        if len(length_objs) == 0:
            ...
            if len(length_objs) != 1:
                logger.warning(
                    "Array {} has {} length object nodes".format(arr, len(length_objs))
                )
        ...
        if length != wildcard:
            ...
            convert_prop_names_to_wildcard(
                G, arr, exclude_length=True
            )  # convert indices to wildcard
            for i, objs in enumerate(tobe_added_objs):
                obj_nodes = to_obj_nodes(G, objs, caller_ast)
                used_objs.update(obj_nodes)
                for obj in obj_nodes:
                    G.add_obj_as_prop(
                        prop_name=wildcard, parent_obj=arr, tobe_added_obj=obj
                    )
        ...
        if length != wildcard:
            try:
                ...
                returned_objs.update(
                    G.get_prop_obj_nodes(
                        parent_obj=arr,
                        prop_name=str(length - 1),
                        branches=extra.branches,
                    )
                )
                name_node = G.get_prop_name_node(
                    prop_name=str(length - 1), parent_obj=arr
                )
            ...
            returned_objs.update(
                G.get_prop_obj_nodes(
                    parent_obj=arr, branches=extra.branches, numeric_only=True
                )
            )
    ...
    for arr in arrays.obj_nodes:
        for prop_name_node in G.get_prop_name_nodes(arr):
            ...
            try:
                ...
                if name == wildcard:
                    returned_objs.update(
                        G.get_obj_nodes(prop_name_node, extra.branches)
                    )
                    continue
                i = int(name)
                if i == 0:
...
def array_p_splice(
    ...
    extra,
    arrays: NodeHandleResult,
    starts: NodeHandleResult = NodeHandleResult(values=[wildcard]),
    delete_counts=NodeHandleResult(values=[wildcard]),
    *items: NodeHandleResult,
):
    used_objs = set()
                ...
                if start != wildcard:
                    try:
                        ...
                        for item in items:
                            ...
                            branch_tag = BranchTagContainer(
                                extra.branches
                            ).get_last_choice_tag()
                            if branch_tag:
                                inserted_part_d.append([{"branch": branch_tag}] * l)
                            else:
                                inserted_part_d.append([{}] * l)
                        ...
                        returned_arr = to_og_array(
                            G, returned_part_e, returned_part_d, caller_ast
                        )
    ...
    used_objs.update(
        arrays.obj_nodes
        + list(filter(lambda x: x != wildcard, chain(*start_sources, *dc_sources)))
    )
...
def array_p_slice(
    ...
    extra,
    arrays: NodeHandleResult,
    starts=NodeHandleResult(values=[wildcard]),
    ends=NodeHandleResult(values=[wildcard]),
):
    start_values, start_sources, _ = to_values(G, starts)
...
def array_p_join(
    ...
    extra,
    arrays: NodeHandleResult,
    seps=NodeHandleResult(values=[","]),
):
    if G.two_pass:
        if G.first_pass:
            return array_p_join_2(G, caller_ast, extra, arrays, seps)
        else:
            return array_p_join_3(G, caller_ast, extra, arrays, seps)
    elif G.auto_exploit:
        return array_p_join_3(G, caller_ast, extra, arrays, seps)
    else:
        return array_p_join_2(G, caller_ast, extra, arrays, seps)
...
def array_p_join_1(
    ...
    for arr in arrays.obj_nodes:
        for i, sep in enumerate(sep_values):
            ...
            elem_objs = G.get_prop_obj_nodes(
                arr, branches=extra.branches, numeric_only=True
            )
    ...
    for arr in arrays.obj_nodes:
        for i, sep in enumerate(sep_values):
            ...
            for j, content in enumerate(array_elems):
                ...
                s += "/".join(
                    [
                        str(val_to_str(G.get_node_attr(obj).get("code")))
                        for obj in content
                    ]
                )
                add_contributes_to(
                    G, array_elems[j], result_str_obj, "string_concat", op_index, random
                )
...
def array_p_reduce(
    ...
    for arr in arrays.obj_nodes:
        ...
        if initial_values is None:
            accumulator = NodeHandleResult(
                obj_nodes=G.get_prop_obj_nodes(arr, "0", extra.branches)
            )
            start = 1
        else:
...
def array_constructor(
    G: Graph, caller_ast, extra, _, length=NodeHandleResult(values=[0]), *args
):
    ...
    for i, l in enumerate(lengths):
        ...
        l = val_to_float(l)
        if l == wildcard or isnan(l) or isinf(l):
            arr = G.add_obj_node(caller_ast, "array", wildcard)
            G.add_obj_as_prop(
                "length", caller_ast, "number", value=wildcard, parent_obj=arr
            )
            G.add_obj_as_prop(
                wildcard, caller_ast, "object", value=wildcard, parent_obj=arr
            )
        else:
            length = int(l)
            arr = G.add_obj_node(caller_ast, "array")
            G.add_obj_as_prop("length", caller_ast, "number", value=l, parent_obj=arr)
...
def object_keys(G: Graph, caller_ast, extra, _, arg: NodeHandleResult, for_array=False):
    ...
    for obj in arg.obj_nodes:
        ...
        # wildcard object
        if (
            G.get_node_attr(obj).get("type") in ["array", "object", wildcard]
...
def object_values(
    G: Graph, caller_ast, extra, _, arg: NodeHandleResult, for_array=False
):
    returned_objs = []
    for obj in arg.obj_nodes:
        arr = G.add_obj_node(caller_ast, "array")
        ...
        # wildcard object
        if (
            G.get_node_attr(obj).get("type") in ["array", "object"]
            and G.get_node_attr(obj).get("code") == wildcard
        ):
            ...
            if not wildcard_prop_objs:  # if the wildcard property does not exist
                added_obj = [
                    G.add_obj_as_prop(
                        wildcard, caller_ast, value=wildcard, parent_obj=obj
                    )
                ]
    ...
    for obj in arg.obj_nodes:
        ...
        if (
            ...
            for prop_obj in wildcard_prop_objs:
                G.add_obj_as_prop("1", parent_obj=child_arr, tobe_added_obj=prop_obj)
            G.add_obj_as_prop(wildcard, parent_obj=arr, tobe_added_obj=child_arr)
        returned_objs.append(arr)
    return NodeHandleResult(obj_nodes=returned_objs)


def object_assign(G: Graph, caller_ast, extra, _, target, *sources):
    obj_nodes = set(to_obj_nodes(G, target, caller_ast))
    for source in sources:
        obj_nodes.update(to_obj_nodes(G, source, caller_ast))
    return NodeHandleResult(obj_nodes=list(obj_nodes), used_objs=list(obj_nodes))
...
def array_p_values(
    G: Graph, caller_ast, extra, this: NodeHandleResult, for_array=False
):
...
def object_p_to_string(G: Graph, caller_ast, extra, this: NodeHandleResult, *args):
    returned_objs = []
...
def object_p_to_string_simp(G: Graph, caller_ast, extra, this: NodeHandleResult, *args):
    string = G.add_obj_node(caller_ast, "string", "[object Object]")
    add_contributes_to(G, this.obj_nodes, string)
    return NodeHandleResult(obj_nodes=[string], used_objs=this.obj_nodes)
...
def object_is(
    G: Graph, caller_ast, extra, _, value1: NodeHandleResult, value2: NodeHandleResult
):
    if set(value1.obj_nodes) == set(value2.obj_nodes) and set(value1.values) == set(
        value2.values
    ):
...
def object_p_has_own_property_f(
    G: Graph, caller_ast, extra, this, pn=NodeHandleResult()
):
    pass


def function_p_call(
    G: Graph, caller_ast, extra, func: NodeHandleResult, this=NodeHandleResult(), *args
):
...
def function_p_apply(
    G: Graph,
    caller_ast,
    extra,
    func: NodeHandleResult,
    this=NodeHandleResult(),
    arg_array=None,
):
    args = []
    if arg_array is not None:
        for array in arg_array.obj_nodes:  # for every possible argument array
            ...
            while True:
                objs = G.get_prop_obj_nodes(
                    parent_obj=array, prop_name=str(i), branches=extra.branches
                )
                if objs:
...
def function_p_bind(
    ...
    for f in func.obj_nodes:
        ...
        logger.log(
            ATTENTION,
            "Bind function {} to {}, this={}, AST node {}".format(
                f, new_func, this.obj_nodes, ast_node
            ),
        )
...
def func_calling_func(G: Graph, call_ast, extra, _, *args):
    ...
    for arg in args:
        filtered_objs = list(
            filter(
                lambda obj: G.get_node_attr(obj).get("type") == "function",
                arg.obj_nodes,
            )
        )
...
def boolean_returning_func(G: Graph, caller_ast, extra, _, *args):
    ...
    for arg in args:
        ...
        # used_objs.update(arg.used_objs)
    return NodeHandleResult(
        obj_nodes=[G.true_obj, G.false_obj], used_objs=list(used_objs)
    )
...
def number_constructor(G: Graph, caller_ast, extra, _, *args):
    ...
    G.add_obj_as_prop(
        "constructor", parent_obj=returned_obj, tobe_added_obj=G.number_cons
    )
    used_objs = chain(*[arg.obj_nodes for arg in args])
    add_contributes_to(G, used_objs, returned_obj)
    return NodeHandleResult(obj_nodes=[returned_obj], used_objs=list(used_objs))
...
def setup_global_objs(G: Graph):
    ...
    process_obj = G.add_obj_to_scope(
        name="process", scope=G.BASE_SCOPE, js_type="object", value=wildcard
    )
    G.set_node_attr(process_obj, ("fake_arg", True))
    G.set_node_attr(process_obj, ("tainted", True))
    argv = G.add_obj_as_prop(
        prop_name="argv", parent_obj=process_obj, js_type="array", value=wildcard
    )
    G.set_node_attr(argv, ("fake_arg", True))
    G.set_node_attr(argv, ("tainted", True))
    version_obj = G.add_obj_as_prop(
        prop_name="versions", parent_obj=process_obj, js_type="object", value=wildcard
    )
    G.add_obj_as_prop(
        prop_name="modules", parent_obj=version_obj, js_type="string", value=wildcard
    )
    G.add_obj_as_prop(
        prop_name="platform", parent_obj=process_obj, js_type="string", value=wildcard
    )
    G.add_obj_as_prop(
        prop_name="arch", parent_obj=process_obj, js_type="string", value=wildcard
    )
...
def json_parse(
    ...
    for i, json_string in enumerate(json_strings):
        obj = opgen.analyze_json_python(G, json_string, extra=extra, call_ast=call_ast)
        if obj is None:
...
def setup_regexp(G: Graph):
    ...
    regexp_prototype = G.get_prop_obj_nodes(
        prop_name="prototype", parent_obj=regexp_cons
    )[0]
...
def regexp_constructor(
        ...
        for p in pattern.obj_nodes:
            for f in flag_objs:
                ...
                added_obj = G.add_obj_node(
                    ast_node=caller_ast, js_type=None, value=code
                )
                G.add_obj_as_prop(
                    prop_name="__proto__",
    ...
    return NodeHandleResult(
        obj_nodes=returned_objs, used_objs=pattern.obj_nodes + flags.obj_nodes
    )


def string_p_replace(
    G: Graph,
    caller_ast,
    extra,
    strs=NodeHandleResult(),
                ...
                if G.get_node_attr(new_sub_str).get("type") == "function":
                    ...
                    if sv is None or ssv is None or sv == wildcard or ssv == wildcard:
                        if unknown_return_obj is None:
                            unknown_return_obj = G.add_obj_node(
                                ast_node=caller_ast, js_type="string", value=wildcard
                            )
                        ...
                        def python_cb(m):
                            ...
                            cb_result, _ = opgen.call_function(
                                G,
                                [callback],
                                args=args,
                                extra=extra,
                            ...
                            cb_returned_values = list(
                                filter(lambda x: x != wildcard, cb_returned_values)
                            )
                            # multiple possibility is ignored here
                            if len(cb_returned_values) > 1:
                                logger.warning(
                                    f"Replace result has multiple possibilities: {cb_returned_values}"
                                )
                        ...
                        if none_flag:
                            output = wildcard
                        logger.debug(
                            "string replace {} in {} -> {}".format(ssv, sv, output)
                        )
                        added_obj = G.add_obj_node(
                            ast_node=caller_ast, js_type="string", value=output
                        )
                        ...
                        for s2 in returned_values:
                            logger.debug(
                                "string replace {} in {} -> {}".format(ssv, sv, s2)
                            )
                            added_obj = G.add_obj_node(
                                ast_node=caller_ast, js_type="string", value=s2
                            )
                            add_contributes_to(G, [s], added_obj)
                            add_contributes_to(G, [substr], added_obj)
                            add_contributes_to(G, [new_sub_str], added_obj)
                    ...
                    if (
                        ...
                        nssv = str(nssv)
                        proto = G.get_prop_obj_nodes(substr, prop_name="__proto__")
                        if proto and proto[0] == G.regexp_prototype:
                            r, glob, sticky = convert_to_python_re(ssv)
                            if r is None:
                                output = wildcard
                            else:
    ...
    return NodeHandleResult(
        ...
        used_objs=list(
            set(
                strs.obj_nodes
                + substrs.obj_nodes
                + new_sub_strs.obj_nodes
                + strs.used_objs
                + substrs.used_objs
                + new_sub_strs.used_objs
            )
        ),
    )


def string_p_replace_value(
    G: Graph,
    caller_ast,
    extra,
    strs=NodeHandleResult(),
...
def string_p_match(G: Graph, caller_ast, extra, strs=NodeHandleResult(), regexps=None):
    if regexps is None or not regexps.obj_nodes:
        ...
        G.add_obj_as_prop(
            ast_node=caller_ast, js_type="string", value="", parent_obj=added_array
        )
    ...
    for s in to_obj_nodes(G, strs, caller_ast):
        for regexp in to_obj_nodes(G, regexps, caller_ast):
            ...
            if sv is None or sv == wildcard or rv == wildcard:
                added_array = G.add_obj_node(ast_node=caller_ast, js_type="array")
                added_obj = G.add_obj_as_prop(
                    ast_node=caller_ast,
                    prop_name="0",
                    js_type="string",
                    parent_obj=added_array,
                )
                add_contributes_to(G, [s], added_obj)
                ...
                if glob:
                    result = r.findall(sv)
                    if result:
                        added_array = G.add_obj_node(
                            ast_node=caller_ast, js_type="array"
                        )
                        for i, u in result:
                            added_obj = G.add_obj_as_prop(
                                ast_node=caller_ast,
    ...
    return NodeHandleResult(
        obj_nodes=returned_objs,
        used_objs=list(
            set(strs.obj_nodes + strs.used_objs + regexps.obj_nodes + regexps.used_objs)
        ),
    )


def string_p_split(
    G: Graph, caller_ast, extra, strs, separators=NodeHandleResult(values=[""])
):
    ...
    for i, s in enumerate(values):
        for j, p in enumerate(sep):
            ...
            if s == wildcard or p == wildcard or type(s) != str or type(p) != str:
...
def string_p_reverse(G: Graph, caller_ast, extra, strs):
    ...
    return NodeHandleResult(
        values=returned_values, value_sources=sources, used_objs=used_objs
    )


def string_p_substring(
    G: Graph,
    caller_ast,
    extra,
    strs,
                ...
                if s != wildcard:
                    if i_start != wildcard:
                        try:
                            ...
                            logger.warning(
                                "string.prototype.substring error, "
                ...
                if s != wildcard:
                    if i_start != wildcard:
                        try:
                            if length != wildcard:
                                returned_values.append(
                                    str(s)[int(i_start) : int(i_start) + int(length)]
                                )
                            else:
                                returned_values.append(str(s)[int(i_start) :])
                            flag = True
...
def string_p_char_at(
    G: Graph, caller_ast, extra, strs, indices=NodeHandleResult(values=[0])
):
...
def math_max(G: Graph, caller_ast, extra, _, *args: NodeHandleResult):
    ...
    if not args:
        ...
        return NodeHandleResult(
            values=returned_values, value_sources=returned_sources, used_objs=used_objs
        )
...
def setup_promise(G: Graph):
    ...
    promise_prototype = G.get_prop_obj_nodes(
        prop_name="prototype", parent_obj=promise_cons
    )[0]
    G.promise_cons = promise_cons
    G.builtin_constructors.append(promise_cons)
    G.promise_prototype = promise_prototype
    G.promise_p_then = G.add_blank_func_as_prop(
        "then", promise_prototype, promise_p_then
    )  # dangerous! # why?
...
def promise_constructor(G: Graph, call_ast, extra, _, executor=NodeHandleResult()):
    ...
    G.add_obj_as_prop(
        "__proto__", parent_obj=promise, tobe_added_obj=G.promise_prototype
    )
    G.add_obj_as_prop("constructor", parent_obj=promise, tobe_added_obj=G.promise_cons)

    def resolve(
        G, caller_ast, extra, this, value=NodeHandleResult(obj_nodes=[G.undefined_obj])
    ):
        nonlocal promise
    ...
    dummy_stmt_ast = G.get_child_nodes(
        G.get_child_nodes(
            G.get_obj_def_ast_node(G.promise_cons), child_type="AST_STMT_LIST"
        )[0],
        child_type="DUMMY_STMT",
    )[0]
    opgen.call_function(
        G,
        executors,
        args=[
            NodeHandleResult(obj_nodes=[resolve_obj]),
            NodeHandleResult(obj_nodes=[reject_obj]),
        ],
        extra=extra,
        call_ast=dummy_stmt_ast if G.new_trace_rule else call_ast,
        promise_related=True,
    )
...
def promise_p_then(
    ...
    dummy_stmt_ast = G.get_child_nodes(
        G.get_child_nodes(
            G.get_obj_def_ast_node(G.promise_p_then), child_type="AST_STMT_LIST"
        )[0],
        child_type="DUMMY_STMT",
    )[0]
...
def promise_resolve(G: Graph, caller_ast, extra, this, value=NodeHandleResult()):
    ...
    G.set_node_attr(promise, ("fulfilled_with", value))
    return NodeHandleResult(
        obj_nodes=[promise], used_objs=to_obj_nodes(G, value, caller_ast)
    )
...
def setup_proxy(G: Graph):
    ...
    proxy_prototype = G.get_prop_obj_nodes(
        prop_name="prototype", parent_obj=proxy_cons
    )[0]
        ...
        for hdl in handler.obj_nodes:
            ...
            if applys:
                for apply in applys:
                    ...
                    def wrapper(
                        G: Graph, caller_ast, _extra, _this=NodeHandleResult(), *args
                    ):
                        ...
                        returned_objs = opgen.call_func_obj(
                            G,
                            apply,
                            _args=[
                                NodeHandleResult(obj_nodes=[tgt]),
                                _this,
                                NodeHandleResult(obj_nodes=[arg_list]),
                            ],
                        )[0]
                        return NodeHandleResult(obj_nodes=returned_objs)

                    proxies.append(
                        G.add_blank_func_with_og_nodes(
