...
def unittest_main(file_path, check_signatures=[], vul_type='os_command',
    ...
    proto_pollution_logger = create_logger('proto_pollution',
            output_type='file', file_name=os.path.join(G.log_dir, "proto_pollution.log"))
    ...
    ipt_logger = create_logger('ipt',
            output_type='file', file_name=os.path.join(G.log_dir, "int_prop_tampering.log"))
    if G.ipt_use:
...
def main():
    ...
    G.logger = create_logger("graph_logger", output_type="file",
