...
class Graph:
    ...
    The graph is built incrementally during symbolic execution and used
    ...
    Example:
        ...
        >>> # Analysis will populate the graph
    """
    ...
    def get_name_from_child(self, nodeid, max_depth=None, order=0):
        """
